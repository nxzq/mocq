...
`[mocq]` is a super small (`<8 kB`) [TypeScript](https://www.typescriptlang.org/) utility 
...
ensures dependent data is there at time of execution allowing data to be stiched together on the fly
